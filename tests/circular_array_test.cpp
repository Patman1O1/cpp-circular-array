...
namespace collections::circular_array_testing {
    ...
    namespace aggregate_testing {
        ...
        TEST(circular_array_aggregate, copy_construction_trivial) {
    ...
    namespace overloaded_operators_testing {
        ...
        TEST(circular_array_operators, is_nothrow_copy_assignable) {
            static_assert(
        ...
        TEST(
            circular_array_operators,
            copy_assignment_returns_self_reference
        ) {
        ...
        TEST(
            circular_array_operators,
            move_assignment_returns_self_reference
        ) {
        ...
        TEST(circular_array_operators, subscript_mut_is_noexcept) {
            static_assert(
                noexcept(std::declval<circular_array<int, 3>&>()[0])
            );
            ...
            static_assert(
                std::is_const_v<
                    std::remove_reference_t<
                        decltype(
                            std::declval<const circular_array<int, 3>&>()[0]
                        )
                    >
                >
            );
        ...
        TEST(
            circular_array_operators,
            subscript_wrap_mut_allows_write
        ) {
    ...
    namespace methods_testing {
        ...
        TEST(circular_array_methods, at_mut_is_noexcept) {
            static_assert(
                noexcept(std::declval<circular_array<int, 3>&>().at(0))
            );
        ...
        TEST(circular_array_methods, at_const_returns_const_ref) {
            static_assert(
                std::same_as<
                    decltype(
                        std::declval<const circular_array<int, 3>&>().at(0)
                    ),
                    circular_array<int, 3>::const_reference
                >
            );
        ...
        TEST(circular_array_methods, front_mut_single_element) {
            ...
            static_assert(
                noexcept(std::declval<circular_array<int, 1>&>().front())
            );
        ...
        TEST(circular_array_methods, front_mut_multi_element) {
            ...
            static_assert(
                noexcept(std::declval<circular_array<int, 3>&>().front())
            );
        ...
        TEST(circular_array_methods, front_const_single_element) {
            static_assert(
                std::same_as<
                    decltype(
                        std::declval<const circular_array<int, 1>&>().front()
                    ),
            ...
            static_assert(
                noexcept(std::declval<const circular_array<int, 1>&>().front())
            );
        ...
        TEST(circular_array_methods, front_const_multi_element) {
            static_assert(
                std::same_as<
                    decltype(
                        std::declval<const circular_array<int, 3>&>().front()
                    ),
                    circular_array<int, 3>::const_reference
                >
            );
            ...
            static_assert(
                noexcept(std::declval<const circular_array<int, 3>&>().front())
            );
        ...
        TEST(circular_array_methods, back_mut_single_element) {
            ...
            static_assert(
                noexcept(std::declval<circular_array<int, 1>&>().back())
            );
        ...
        TEST(circular_array_methods, back_mut_multi_element) {
            ...
            static_assert(
                noexcept(std::declval<circular_array<int, 3>&>().back())
            );
        ...
        TEST(circular_array_methods, back_const_single_element) {
            ...
            static_assert(
                noexcept(std::declval<const circular_array<int, 1>&>().back())
            );
        ...
        TEST(circular_array_methods, data_returns_pointer_to_first_element) {
            ...
            static_assert(
                std::same_as<
                    decltype(
                        std::declval<const circular_array<int, 3>&>().data()
                    ),
            ...
            static_assert(
                noexcept(std::declval<circular_array<int, 3>&>().data())
            );
        ...
        TEST(circular_array_methods, size) {
            ...
            static_assert(
                std::same_as<
                    decltype(
                        std::declval<const circular_array<int, 3>&>().size()
                    ),
        ...
        TEST(circular_array_methods, max_size) {
            static_assert(3 == circular_array<int, 3>{}.max_size());
        }

        TEST(circular_array_methods, empty) {
        ...
        TEST(
            circular_array_methods,
            fill_noexcept_follows_element_assignment
        ) {
            static_assert(
                noexcept(std::declval<circular_array<int, 3>&>().fill(0))
            );
        ...
        TEST(
            circular_array_methods,
            sort_predicate_overload_partial_descending
        ) {
            circular_array values = {5, 3, 1, 4, 2};
            values.sort(values.begin() + 1, values.begin() + 4,
                        std::greater<int>{});
        ...
        TEST(
            circular_array_methods,
            sort_predicate_overload_empty_range_no_op
        ) {
            circular_array values = {3, 1, 2};
            const auto before = values;
        ...
        TEST(circular_array_methods, sort_non_trivial_type) {
            circular_array<std::string, 4> values = {
        ...
        TEST(
            ...
            struct item {
                int key;
                int order;
                bool operator==(const struct item&) const = default;
                auto operator<=>(const struct item&) const = default;
            };

            circular_array<struct item, 6> values = {
                item{2, 0},
                item{1, 1},
                item{2, 2},
                item{1, 3},
            ...
            values.stable_sort(
                values.begin(),
                values.end(),
                [](const struct item& a, const struct item& b) {
                    return a.key < b.key;
                });
        ...
        TEST(
            circular_array_methods,
            stable_sort_range_overload_empty_range_no_op
        ) {
            circular_array values = {3, 1, 2};
            const auto before = values;
        ...
        TEST(
            circular_array_methods,
            stable_sort_predicate_overload_descending
        ) {
            circular_array values = {3, 1, 4, 1, 5, 9, 2, 6};
            values.stable_sort(
        ...
        TEST(
            circular_array_methods,
            stable_sort_predicate_overload_empty_range_no_op
        ) {
            circular_array values = {3, 1, 2};
            const auto before = values;
    ...
    namespace iterator_testing {
        namespace trait_testing {
            TEST(circular_array_iterator_traits, is_random_access_iterator) {
                static_assert(
        ...
        namespace constructor_testing {
            TEST(
                circular_array_iterator_constructors,
                default_constructed_iterators_are_equal
            ) {
            ...
            TEST(
                circular_array_iterator_constructors,
                copy_constructed_iterator_equals_original
            ) {
                circular_array values = {1, 2, 3};
            ...
            TEST(
                circular_array_iterator_constructors,
                move_constructed_iterator_equals_original
            ) {
                circular_array values = {1, 2, 3};
        ...
        namespace destructor_testing {
            TEST(circular_array_iterator_destructor, is_destructible) {
                static_assert(
                    std::is_destructible_v<circular_array<int, 0>::iterator>
                );
            }
        } // namespace destructor_testing
        ...
        namespace operator_testing {
            TEST(
                circular_array_iterator_operators,
                dereference_reads_element
            ) {
                circular_array values = {10, 20, 30};
                auto it = values.begin();
            ...
            TEST(
                circular_array_iterator_operators,
                dereference_write_mutates_array
            ) {
                circular_array values = {10, 20, 30};
                *values.begin() = 99;
            ...
            TEST(circular_array_iterator_operators, arrow_operator) {
            ...
            TEST(circular_array_iterator_operators, add_operator) {
                circular_array values = {1, 2, 3};
                auto it = values.begin() + 2;
                EXPECT_EQ(3, *it);
            }

            TEST(circular_array_iterator_operators, add_iterator_operator) {
                circular_array values = {1, 2, 3};
                auto it = 2 + values.begin();
                EXPECT_EQ(3, *it);
            }

            TEST(circular_array_iterator_operators, subtract_operator) {
                circular_array values = {1, 2, 3};
                auto it = values.end() - 2;
                EXPECT_EQ(2, *it);
            }

            TEST(circular_array_iterator_operators, iterator_minus_iterator) {
                circular_array values = {1, 2, 3};
            ...
            TEST(circular_array_iterator_operators, subscript_random_access) {
                circular_array values = {10, 20, 30};
                auto it = values.begin();
            ...
            TEST(circular_array_iterator_operators, subscript_from_middle) {
                circular_array values = {10, 20, 30};
            ...
            TEST(circular_array_iterator_operators, equality_begin_equals_begin) {
                circular_array values = {1, 2, 3};
                EXPECT_EQ(values.begin(), values.begin());
            }

            TEST(circular_array_iterator_operators, equality_begin_not_equals_end) {
                circular_array values = {1, 2, 3};
                EXPECT_NE(values.begin(), values.end());
            }

            TEST(circular_array_iterator_operators, ordering_less_than) {
                circular_array values = {1, 2, 3};
                EXPECT_LT(values.begin(), values.end());
                EXPECT_LT(values.begin(), values.begin() + 1);
            }

            TEST(circular_array_iterator_operators, ordering_greater_than) {
                circular_array values = {1, 2, 3};
            ...
            TEST(
                circular_array_iterator_operators,
                ordering_less_equal_greater_equal
            ) {
                circular_array values = {1, 2, 3};
            ...
            TEST(
                circular_array_iterator_operators,
                cross_comparison_iterator_const_iterator
            ) {
                circular_array values = {1, 2, 3};
                auto it  = values.begin();
        ...
        namespace range_testing {
            ...
            TEST(
                circular_array_iterator_range,
                rbegin_starts_at_last_element
            ) {
                circular_array values = {1, 2, 3};
            ...
            TEST(circular_array_iterator_range, increment_past_end_wraps) {
                circular_array values = {10, 20, 30};
            ...
            TEST(
                circular_array_iterator_range,
                negative_offset_iterator_arithmetic
            ) {
                circular_array values = {10, 20, 30};
            ...
            TEST(
                circular_array_iterator_range,
                subscript_wrap_through_iterator
            ) {
                circular_array values = {10, 20, 30};
                auto it = values.begin();
            ...
            TEST(circular_array_iterator_range, std_copy_to_vector) {
                const circular_array values = {1, 2, 3};
            ...
            TEST(circular_array_iterator_range, std_fill) {
            ...
            TEST(circular_array_iterator_range, std_find) {
                circular_array values = {10, 20, 30};
            ...
            TEST(circular_array_iterator_range, std_transform) {
                circular_array values = {1, 2, 3};
            ...
            TEST(circular_array_iterator_range, std_sort) {
                circular_array values = {3, 1, 2};
                std::sort(values.begin(), values.end());
                EXPECT_TRUE(std::is_sorted(values.begin(), values.end()));
            }

            TEST(circular_array_iterator_range, ranges_for_each) {
                circular_array values = {1, 2, 3};
                int sum = 0;
            ...
            TEST(circular_array_iterator_range, ranges_sort) {
                circular_array values = {3, 1, 2};
                std::ranges::sort(values);
                EXPECT_TRUE(std::ranges::is_sorted(values));
            }

            TEST(circular_array_iterator_range, ranges_reverse) {
                circular_array values = {1, 2, 3};
    ...
    namespace const_iterator_testing {
        namespace trait_testing {
            TEST(
                circular_array_const_iterator_traits,
            ...
            TEST(
                circular_array_iterator_traits,
                satisfies_random_access_range
            ) {
                static_assert(
                ...
                static_assert(
                    std::ranges::sized_range<const circular_array<int, 3>>
                );
        ...
        namespace constructor_testing {
            TEST(
                circular_array_const_iterator_constructors,
                default_constructed_are_equal
            ) {
        ...
        namespace destructor_testing {
            TEST(circular_array_const_iterator_destructor, is_destructible) {
                static_assert(
                    std::is_destructible_v<
                        circular_array<int, 0>::const_iterator
                    >
                );
            }
        } // namespace destructor_testing
        ...
        namespace overloaded_operator_testing {
            TEST(
                circular_array_const_iterator_operators,
                dereference_reads_element
            ) {
                circular_array values = {10, 20, 30};
            ...
            TEST(circular_array_const_iterator_operators, arrow_operator) {
                const circular_array<std::string, 2> values = {
                    "hello",
                    "world"
                };
                auto it = values.begin();
            ...
            TEST(circular_array_const_iterator_operators, postfix_decrement) {
                circular_array values = {1, 2, 3};
                auto it  = values.cend();
                auto old = it--;
            ...
            TEST(
                circular_array_const_iterator_operators,
                const_iterator_minus_const_iterator
            ) {
                circular_array values = {1, 2, 3};
            ...
            TEST(circular_array_const_iterator_operators, subscript_operator) {
        ...
        namespace range_testing {
            TEST(
                circular_array_const_iterator_range,
                cbegin_and_cend_span_the_array
            ) {
                static_assert([] -> bool {
                    circular_array values = {1, 2, 3};
                    return 1 == values[0] &&
                           values.cend() - values.cbegin() == 3;
                }());

                const circular_array values = {1, 2, 3};

                EXPECT_EQ(values.data(), values.cbegin());
                EXPECT_EQ(values.data() + 3, values.cend());
                EXPECT_EQ(3, values.cend() - values.cbegin());
                EXPECT_EQ(1, *values.cbegin());
                EXPECT_EQ(3, *(values.cend() - 1));
            }
            ...
            TEST(circular_array_const_iterator_range, const_rbegin_rend) {
                const circular_array values = {1, 2, 3};
            ...
            TEST(circular_array_const_iterator_range, crbegin_and_crend) {
                constexpr circular_array values = {1, 2, 3};
            ...
            TEST(circular_array_const_iterator_range, std_copy_to_vector) {
                const circular_array values = {1, 2, 3};
                std::vector<int> out(3);
                std::copy(values.cbegin(), values.cend(), out.begin());
                EXPECT_THAT(out, testing::ElementsAre(1, 2, 3));
            }

            TEST(circular_array_const_iterator_range, std_find) {
                circular_array values = {10, 20, 30};
                auto it = std::find(values.cbegin(), values.cend(), 20);

                ASSERT_NE(it, values.cend());
                EXPECT_EQ(20, *it);
                EXPECT_EQ(values.cbegin() + 1, it);
            }
        } // namespace range_testing
    } // namespace const_iterator_testing
} // namespace collections::circular_array_testing
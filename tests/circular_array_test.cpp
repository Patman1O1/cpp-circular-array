    ...
    namespace iterator_testing {
        ...
        namespace overloaded_operator_testing {
            TEST(
                ...
                comparison_operator_compile_time_same_iterators
            ) {
            ...
            TEST(
                circular_array_iterator_overloaded_operators,
                comparison_operator_run_time_same_iterators
            ) {
                const circular_array<int, 0>::iterator lhs;
                const circular_array<int, 0>::iterator rhs;
            ...
            TEST(
                circular_array_iterator_overloaded_operators,
                comparison_operator_compile_time_different_iterators
            ) {
                static_assert([]() -> bool {
                    circular_array arr = {1, 2, 3};
            ...
            TEST(
                circular_array_iterator_overloaded_operators,
                comparison_operator_run_time_different_iterators
            ) {
                circular_array arr = {1, 2, 3};
                const auto lhs = arr.begin();
                const auto rhs = arr.end();
            ...
            TEST(
                circular_array_iterator_overloaded_operators,
                prefix_increment_operator_run_time_same_iterators
            ) {
                static
                const circular_array<int, 0>::iterator lhs;
                const circular_array<int, 0>::iterator rhs;
